    ...
    >
      ...
      >
        ...
        <p className="cyber-text mb-6 text-lg leading-relaxed">
          {lang === "es"
            ? "Mi enfoque integra ciberseguridad e infraestructura desde el dise\u00f1o. Analizo riesgos, superficie de ataque y dependencias operativas para construir servicios m\u00e1s resistentes en entornos reales."
        ...
        <p className="cyber-text mb-6 text-lg leading-relaxed">
          {lang === "es"
            ? "Priorizo automatizaci\u00f3n, observabilidad y respuesta a incidentes como parte del ciclo de vida. Esto permite detectar desviaciones r\u00e1pido y sostener continuidad operativa aun bajo eventos adversos."
        ...
        <p className="cyber-text text-lg leading-relaxed">
          {lang === "es"
            ? "El objetivo es aportar a equipos de infraestructura y seguridad con pr\u00e1cticas medibles, despliegues confiables y una cultura de mejora continua."
