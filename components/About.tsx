      ...
      <FadeInSection>
        <div className="section-shell mx-auto max-w-5xl rounded-2xl p-8 md:p-12">
          ...
          <p className="cyber-text text-lg leading-relaxed">
            {lang === "es"
              ? "Soy estudiante de ingenier\u00eda de sistemas con foco en redes, infraestructura y seguridad operacional. Trabajo con protocolos como TLS y SSH, buenas pr\u00e1cticas de hardening en Linux y despliegues controlados en entornos VPS."
          ...
          <p className="cyber-text mt-6 text-lg leading-relaxed">
            {lang === "es"
              ? "Actualmente fortalezco procesos de CI/CD, monitoreo y an\u00e1lisis de logs para reducir superficie de ataque y mejorar disponibilidad. Mi objetivo es evolucionar a roles de ciberseguridad defensiva y confiabilidad sobre plataformas cloud."
